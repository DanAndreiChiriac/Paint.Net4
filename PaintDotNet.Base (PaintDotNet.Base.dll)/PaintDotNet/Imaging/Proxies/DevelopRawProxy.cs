namespace PaintDotNet.Imaging.Proxies
{
    ...
    public class DevelopRawProxy : ObjectRefProxy<IDevelopRaw>, IDevelopRaw, IBitmapFrameDecode, IBitmapSource, IImagingObject, IObjectRef, IDisposable, IIsDisposed
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public DevelopRawProxy(IDevelopRaw objectRef, ObjectRefProxyOptions proxyOptions) : base(objectRef, proxyOptions)
        {
        }
