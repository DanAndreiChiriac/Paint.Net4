namespace PaintDotNet.Imaging.Proxies
{
    ...
    public class BitmapSourceProxy : ObjectRefProxy<IBitmapSource>, IBitmapSource, IImagingObject, IObjectRef, IDisposable, IIsDisposed
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public BitmapSourceProxy(IBitmapSource objectRef, ObjectRefProxyOptions proxyOptions) : base(objectRef, proxyOptions)
        {
        }
