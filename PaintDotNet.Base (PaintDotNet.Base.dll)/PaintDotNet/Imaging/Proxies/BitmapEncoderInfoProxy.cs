namespace PaintDotNet.Imaging.Proxies
{
    ...
    public class BitmapEncoderInfoProxy : ObjectRefProxy<IBitmapEncoderInfo>, IBitmapEncoderInfo, IBitmapCodecInfo, IImagingComponentInfo, IImagingObject, IObjectRef, IDisposable, IIsDisposed
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public BitmapEncoderInfoProxy(IBitmapEncoderInfo objectRef, ObjectRefProxyOptions proxyOptions) : base(objectRef, proxyOptions)
        {
        }
