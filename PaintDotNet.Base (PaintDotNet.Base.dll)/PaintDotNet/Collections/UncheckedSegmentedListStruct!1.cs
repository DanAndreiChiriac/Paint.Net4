namespace PaintDotNet.Collections
{
    ...
    public struct UncheckedSegmentedListStruct<T> : ISegmentedList<T>, ISegmentedCollection<T>, ICollection<T>, IEnumerable<T>, IEnumerable, IList<T>, IReadOnlyList<T>, IReadOnlyCollection<T>, IModifyElementByRef<T>, IAddRange<T>, IToArray<T>, ITrimExcess
    {
        ...
        public T this[int index]
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => 
                this.source.GetUnchecked(index);
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            set
            {
                this.source.SetUnchecked(index, value);
            }
        }
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void ModifyByRef<TActionByRef>(int index, TActionByRef modifyAction) where TActionByRef: struct, IActionByRef<T>
        {
            this.source.ModifyByRefUnchecked<TActionByRef>(index, modifyAction);
        }
