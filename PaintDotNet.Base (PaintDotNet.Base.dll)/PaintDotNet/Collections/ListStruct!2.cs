namespace PaintDotNet.Collections
{
    ...
    public struct ListStruct<T, TList> : IList<T>, ICollection<T>, IEnumerable<T>, IEnumerable, IReadOnlyList<T>, IReadOnlyCollection<T>, IToArray<T> where TList: IList<T>
    {
        private TList source;
        public ListStruct(TList source)
        {
            this.source = source;
        }
