namespace PaintDotNet.Direct2D.Proxies
{
    ...
    public class DeviceResourceFactoryProxy : ObjectRefProxy<IDeviceResourceFactory>, IDeviceResourceFactory, IDirect2DResource, IDirect2DObject, IObjectRef, IDisposable, IIsDisposed
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public DeviceResourceFactoryProxy(IDeviceResourceFactory objectRef, ObjectRefProxyOptions proxyOptions) : base(objectRef, proxyOptions)
        {
        }
