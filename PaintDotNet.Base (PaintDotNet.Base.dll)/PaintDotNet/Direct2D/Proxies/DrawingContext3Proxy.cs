namespace PaintDotNet.Direct2D.Proxies
{
    ...
    public class DrawingContext3Proxy : ObjectRefProxy<IDrawingContext3>, IDrawingContext3, IDrawingContext2, IDrawingContext1, IDrawingContext, IDirect2DResource, IDirect2DObject, IObjectRef, IDisposable, IIsDisposed, IDeviceResourceFactory, IResourceCache, IDeviceResourceFactory1, IDeviceResourceFactory2, IDeviceResourceFactory3
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public DrawingContext3Proxy(IDrawingContext3 objectRef, ObjectRefProxyOptions proxyOptions) : base(objectRef, proxyOptions)
        {
        }
