namespace PaintDotNet.Direct2D.Proxies
{
    ...
    public class PathGeometryProxy : ObjectRefProxy<IPathGeometry>, IPathGeometry, IGeometry, IDirect2DResource, IDirect2DObject, IObjectRef, IDisposable, IIsDisposed
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public PathGeometryProxy(IPathGeometry objectRef, ObjectRefProxyOptions proxyOptions) : base(objectRef, proxyOptions)
        {
        }
