namespace PaintDotNet.Direct2D.Proxies
{
    ...
    public class DeviceContextProxy : ObjectRefProxy<IDeviceContext>, IDeviceContext, IRenderTarget, IDrawingContext, IDirect2DResource, IDirect2DObject, IObjectRef, IDisposable, IIsDisposed, IDeviceResourceFactory, IResourceCache, IDrawingContext1, IDeviceResourceFactory1
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public DeviceContextProxy(IDeviceContext objectRef, ObjectRefProxyOptions proxyOptions) : base(objectRef, proxyOptions)
        {
        }
