namespace PaintDotNet.Direct2D.Proxies
{
    ...
    public class DeviceContext2Proxy : ObjectRefProxy<IDeviceContext2>, IDeviceContext2, IDeviceContext1, IDeviceContext, IRenderTarget, IDrawingContext, IDirect2DResource, IDirect2DObject, IObjectRef, IDisposable, IIsDisposed, IDeviceResourceFactory, IResourceCache, IDrawingContext1, IDeviceResourceFactory1, IDrawingContext2, IDeviceResourceFactory2, IDrawingContext3, IDeviceResourceFactory3
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public DeviceContext2Proxy(IDeviceContext2 objectRef, ObjectRefProxyOptions proxyOptions) : base(objectRef, proxyOptions)
        {
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void DrawGeometryRealization(IGeometryRealization geometryRealization, IBrush brush)
        {
            base.innerRefT.DrawGeometryRealization(geometryRealization, brush);
        }
        ...
        public PaintDotNet.Direct2D.PrimitiveBlend PrimitiveBlend
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => 
                base.innerRefT.PrimitiveBlend;
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            set
            {
                base.innerRefT.PrimitiveBlend = value;
            }
        }
