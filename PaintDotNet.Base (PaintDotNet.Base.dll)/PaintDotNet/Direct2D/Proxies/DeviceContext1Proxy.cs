namespace PaintDotNet.Direct2D.Proxies
{
    ...
    public class DeviceContext1Proxy : ObjectRefProxy<IDeviceContext1>, IDeviceContext1, IDeviceContext, IRenderTarget, IDrawingContext, IDirect2DResource, IDirect2DObject, IObjectRef, IDisposable, IIsDisposed, IDeviceResourceFactory, IResourceCache, IDrawingContext1, IDeviceResourceFactory1, IDrawingContext2, IDeviceResourceFactory2
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public DeviceContext1Proxy(IDeviceContext1 objectRef, ObjectRefProxyOptions proxyOptions) : base(objectRef, proxyOptions)
        {
        }
