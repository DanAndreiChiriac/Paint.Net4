namespace PaintDotNet.Direct2D.Proxies
{
    ...
    public class PathGeometry1Proxy : ObjectRefProxy<IPathGeometry1>, IPathGeometry1, IPathGeometry, IGeometry, IDirect2DResource, IDirect2DObject, IObjectRef, IDisposable, IIsDisposed
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public PathGeometry1Proxy(IPathGeometry1 objectRef, ObjectRefProxyOptions proxyOptions) : base(objectRef, proxyOptions)
        {
        }
        ...
        public int FigureCount =>
            base.innerRefT.FigureCount;

        public int SegmentCount =>
            base.innerRefT.SegmentCount;
    }
}
