namespace PaintDotNet.Direct2D.Proxies
{
    ...
    public class DrawingContextProxy : ObjectRefProxy<IDrawingContext>, IDrawingContext, IDirect2DResource, IDirect2DObject, IObjectRef, IDisposable, IIsDisposed, IDeviceResourceFactory, IResourceCache
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public DrawingContextProxy(IDrawingContext objectRef, ObjectRefProxyOptions proxyOptions) : base(objectRef, proxyOptions)
        {
        }
