namespace PaintDotNet.Direct2D.Proxies
{
    ...
    public class DeviceResourceFactory3Proxy : ObjectRefProxy<IDeviceResourceFactory3>, IDeviceResourceFactory3, IDeviceResourceFactory2, IDeviceResourceFactory1, IDeviceResourceFactory, IDirect2DResource, IDirect2DObject, IObjectRef, IDisposable, IIsDisposed
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public DeviceResourceFactory3Proxy(IDeviceResourceFactory3 objectRef, ObjectRefProxyOptions proxyOptions) : base(objectRef, proxyOptions)
        {
        }
