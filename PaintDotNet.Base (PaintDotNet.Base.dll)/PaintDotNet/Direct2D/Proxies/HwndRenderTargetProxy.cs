namespace PaintDotNet.Direct2D.Proxies
{
    ...
    public class HwndRenderTargetProxy : ObjectRefProxy<IHwndRenderTarget>, IHwndRenderTarget, IRenderTarget, IDrawingContext, IDirect2DResource, IDirect2DObject, IObjectRef, IDisposable, IIsDisposed, IDeviceResourceFactory, IResourceCache
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public HwndRenderTargetProxy(IHwndRenderTarget objectRef, ObjectRefProxyOptions proxyOptions) : base(objectRef, proxyOptions)
        {
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Resize(SizeInt32 pixelSize)
        {
            base.innerRefT.Resize(pixelSize);
        }
        ...
        public PaintDotNet.Direct2D.WindowState WindowState =>
            base.innerRefT.WindowState;
    }
}
