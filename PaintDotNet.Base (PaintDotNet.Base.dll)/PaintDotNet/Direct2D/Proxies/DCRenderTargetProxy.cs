namespace PaintDotNet.Direct2D.Proxies
{
    ...
    public class DCRenderTargetProxy : ObjectRefProxy<IDCRenderTarget>, IDCRenderTarget, IRenderTarget, IDrawingContext, IDirect2DResource, IDirect2DObject, IObjectRef, IDisposable, IIsDisposed, IDeviceResourceFactory, IResourceCache
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public DCRenderTargetProxy(IDCRenderTarget objectRef, ObjectRefProxyOptions proxyOptions) : base(objectRef, proxyOptions)
        {
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void BindDC(IntPtr hdc, RectInt32 subRect)
        {
            base.innerRefT.BindDC(hdc, subRect);
        }
