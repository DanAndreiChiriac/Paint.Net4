namespace PaintDotNet.Direct2D.Proxies
{
    ...
    public class TransformedGeometryProxy : ObjectRefProxy<ITransformedGeometry>, ITransformedGeometry, IGeometry, IDirect2DResource, IDirect2DObject, IObjectRef, IDisposable, IIsDisposed
    {
