namespace PaintDotNet.Direct2D.Proxies
{
    ...
    public class RectangleGeometryProxy : ObjectRefProxy<IRectangleGeometry>, IRectangleGeometry, IGeometry, IDirect2DResource, IDirect2DObject, IObjectRef, IDisposable, IIsDisposed
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public RectangleGeometryProxy(IRectangleGeometry objectRef, ObjectRefProxyOptions proxyOptions) : base(objectRef, proxyOptions)
        {
        }
