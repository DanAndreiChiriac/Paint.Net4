namespace PaintDotNet.Direct2D.Proxies
{
    ...
    public class RoundedRectangleGeometryProxy : ObjectRefProxy<IRoundedRectangleGeometry>, IRoundedRectangleGeometry, IGeometry, IDirect2DResource, IDirect2DObject, IObjectRef, IDisposable, IIsDisposed
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public RoundedRectangleGeometryProxy(IRoundedRectangleGeometry objectRef, ObjectRefProxyOptions proxyOptions) : base(objectRef, proxyOptions)
        {
        }
        ...
        public RoundedRectFloat RoundedRect =>
            base.innerRefT.RoundedRect;
    }
}
