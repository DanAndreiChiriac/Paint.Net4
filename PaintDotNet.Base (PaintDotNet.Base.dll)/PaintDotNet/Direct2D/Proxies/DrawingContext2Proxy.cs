namespace PaintDotNet.Direct2D.Proxies
{
    ...
    public class DrawingContext2Proxy : ObjectRefProxy<IDrawingContext2>, IDrawingContext2, IDrawingContext1, IDrawingContext, IDirect2DResource, IDirect2DObject, IObjectRef, IDisposable, IIsDisposed, IDeviceResourceFactory, IResourceCache, IDeviceResourceFactory1, IDeviceResourceFactory2
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public DrawingContext2Proxy(IDrawingContext2 objectRef, ObjectRefProxyOptions proxyOptions) : base(objectRef, proxyOptions)
        {
        }
