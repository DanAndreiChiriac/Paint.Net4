namespace PaintDotNet.Direct2D.Proxies
{
    ...
    public class DrawingContext1Proxy : ObjectRefProxy<IDrawingContext1>, IDrawingContext1, IDrawingContext, IDirect2DResource, IDirect2DObject, IObjectRef, IDisposable, IIsDisposed, IDeviceResourceFactory, IResourceCache, IDeviceResourceFactory1
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public DrawingContext1Proxy(IDrawingContext1 objectRef, ObjectRefProxyOptions proxyOptions) : base(objectRef, proxyOptions)
        {
        }
