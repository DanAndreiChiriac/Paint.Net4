namespace PaintDotNet.Direct2D.Proxies
{
    ...
    public class GeometryFactoryProxy : ObjectRefProxy<IGeometryFactory>, IGeometryFactory, IDirect2DObject, IObjectRef, IDisposable, IIsDisposed
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public GeometryFactoryProxy(IGeometryFactory objectRef, ObjectRefProxyOptions proxyOptions) : base(objectRef, proxyOptions)
        {
        }
