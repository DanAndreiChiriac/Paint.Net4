namespace PaintDotNet.Direct2D.Proxies
{
    ...
    public class GeometryGroupProxy : ObjectRefProxy<IGeometryGroup>, IGeometryGroup, IGeometry, IDirect2DResource, IDirect2DObject, IObjectRef, IDisposable, IIsDisposed
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public GeometryGroupProxy(IGeometryGroup objectRef, ObjectRefProxyOptions proxyOptions) : base(objectRef, proxyOptions)
        {
        }
        ...
        public PaintDotNet.Direct2D.FillMode FillMode =>
            base.innerRefT.FillMode;

        public IList<IGeometry> SourceGeometries =>
            base.innerRefT.SourceGeometries;
    }
}
