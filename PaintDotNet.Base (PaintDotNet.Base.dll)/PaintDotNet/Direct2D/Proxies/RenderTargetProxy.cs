namespace PaintDotNet.Direct2D.Proxies
{
    ...
    public class RenderTargetProxy : ObjectRefProxy<IRenderTarget>, IRenderTarget, IDrawingContext, IDirect2DResource, IDirect2DObject, IObjectRef, IDisposable, IIsDisposed, IDeviceResourceFactory, IResourceCache
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public RenderTargetProxy(IRenderTarget objectRef, ObjectRefProxyOptions proxyOptions) : base(objectRef, proxyOptions)
        {
        }
