namespace PaintDotNet.Direct2D.Proxies
{
    ...
    public class EllipseGeometryProxy : ObjectRefProxy<IEllipseGeometry>, IEllipseGeometry, IGeometry, IDirect2DResource, IDirect2DObject, IObjectRef, IDisposable, IIsDisposed
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public EllipseGeometryProxy(IEllipseGeometry objectRef, ObjectRefProxyOptions proxyOptions) : base(objectRef, proxyOptions)
        {
        }
        ...
        public EllipseFloat Ellipse =>
            base.innerRefT.Ellipse;
