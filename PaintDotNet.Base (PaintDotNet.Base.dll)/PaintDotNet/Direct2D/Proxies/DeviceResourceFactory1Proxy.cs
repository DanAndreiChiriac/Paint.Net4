namespace PaintDotNet.Direct2D.Proxies
{
    ...
    public class DeviceResourceFactory1Proxy : ObjectRefProxy<IDeviceResourceFactory1>, IDeviceResourceFactory1, IDeviceResourceFactory, IDirect2DResource, IDirect2DObject, IObjectRef, IDisposable, IIsDisposed
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public DeviceResourceFactory1Proxy(IDeviceResourceFactory1 objectRef, ObjectRefProxyOptions proxyOptions) : base(objectRef, proxyOptions)
        {
        }
