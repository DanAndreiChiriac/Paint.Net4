namespace PaintDotNet.MemoryManagement.Proxies
{
    ...
    internal sealed class VirtualMemoryAllocatorProxyFactory : ObjectRefProxyFactory
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override ObjectRefProxy CreateProxy(IObjectRef objectRef, ObjectRefProxyOptions proxyOptions) => 
            new VirtualMemoryAllocatorProxy((IVirtualMemoryAllocator) objectRef, proxyOptions);
    }
}
