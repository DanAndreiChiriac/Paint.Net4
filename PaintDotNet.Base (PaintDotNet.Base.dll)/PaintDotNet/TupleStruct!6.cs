namespace PaintDotNet
{
    ...
    public struct TupleStruct<T1, T2, T3, T4, T5, T6> : IEquatable<TupleStruct<T1, T2, T3, T4, T5, T6>>
    {
        ...
        private T5 item5;
        private T6 item6;
        public static implicit operator Tuple<T1, T2, T3, T4, T5, T6>(TupleStruct<T1, T2, T3, T4, T5, T6> from) => 
            new Tuple<T1, T2, T3, T4, T5, T6>(from.Item1, from.Item2, from.Item3, from.Item4, from.Item5, from.Item6);

        public static implicit operator TupleStruct<T1, T2, T3, T4, T5, T6>(Tuple<T1, T2, T3, T4, T5, T6> from) => 
            new TupleStruct<T1, T2, T3, T4, T5, T6>(from.Item1, from.Item2, from.Item3, from.Item4, from.Item5, from.Item6);
        ...
        public static bool operator ==(TupleStruct<T1, T2, T3, T4, T5, T6> lhs, TupleStruct<T1, T2, T3, T4, T5, T6> rhs) => 
            lhs.Equals(rhs);
        ...
        static TupleStruct()
        {
            TupleStruct<T1, T2, T3, T4, T5, T6>.item1Type = typeof(T1);
            TupleStruct<T1, T2, T3, T4, T5, T6>.item1IsValueType = TupleStruct<T1, T2, T3, T4, T5, T6>.item1Type.IsValueType;
            TupleStruct<T1, T2, T3, T4, T5, T6>.item1Comparer = EqualityComparer<T1>.Default;
            TupleStruct<T1, T2, T3, T4, T5, T6>.item2Type = typeof(T2);
            TupleStruct<T1, T2, T3, T4, T5, T6>.item2IsValueType = TupleStruct<T1, T2, T3, T4, T5, T6>.item2Type.IsValueType;
            TupleStruct<T1, T2, T3, T4, T5, T6>.item2Comparer = EqualityComparer<T2>.Default;
            TupleStruct<T1, T2, T3, T4, T5, T6>.item3Type = typeof(T3);
            TupleStruct<T1, T2, T3, T4, T5, T6>.item3IsValueType = TupleStruct<T1, T2, T3, T4, T5, T6>.item3Type.IsValueType;
            TupleStruct<T1, T2, T3, T4, T5, T6>.item3Comparer = EqualityComparer<T3>.Default;
            TupleStruct<T1, T2, T3, T4, T5, T6>.item4Type = typeof(T4);
            TupleStruct<T1, T2, T3, T4, T5, T6>.item4IsValueType = TupleStruct<T1, T2, T3, T4, T5, T6>.item4Type.IsValueType;
            TupleStruct<T1, T2, T3, T4, T5, T6>.item4Comparer = EqualityComparer<T4>.Default;
            TupleStruct<T1, T2, T3, T4, T5, T6>.item5Type = typeof(T5);
            TupleStruct<T1, T2, T3, T4, T5, T6>.item5IsValueType = TupleStruct<T1, T2, T3, T4, T5, T6>.item5Type.IsValueType;
            TupleStruct<T1, T2, T3, T4, T5, T6>.item5Comparer = EqualityComparer<T5>.Default;
            TupleStruct<T1, T2, T3, T4, T5, T6>.item6Type = typeof(T6);
            TupleStruct<T1, T2, T3, T4, T5, T6>.item6IsValueType = TupleStruct<T1, T2, T3, T4, T5, T6>.item6Type.IsValueType;
            TupleStruct<T1, T2, T3, T4, T5, T6>.item6Comparer = EqualityComparer<T6>.Default;
        }
    }
}
