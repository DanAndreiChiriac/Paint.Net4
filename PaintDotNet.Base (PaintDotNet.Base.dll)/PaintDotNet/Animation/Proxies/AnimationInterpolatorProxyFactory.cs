namespace PaintDotNet.Animation.Proxies
{
    ...
    internal sealed class AnimationInterpolatorProxyFactory : ObjectRefProxyFactory
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public override ObjectRefProxy CreateProxy(IObjectRef objectRef, ObjectRefProxyOptions proxyOptions) => 
            new AnimationInterpolatorProxy((IAnimationInterpolator) objectRef, proxyOptions);
    }
}
